...
const TriggerScheduleBox = () => {
  ...
  return (
    <div className={`mb-6 w-full rounded-lg bg-neutral-n0 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.15)] transition-all duration-300 border ${isOpen && menuType == "scheduleConfig"? "border-extended-dark-blue-25" : "border-neutral-n30"}`}>
      ...
      {range?.from && range?.to && (
        <div
          ...
          className="body-02 w-full cursor-pointer rounded-b-lg p-8"
        >
          <div>
