...
const WorkflowStepBox: React.FC<WorkflowStep> = ({ index, action }) => {
  ...
  return (
    ...
    >
      <button className="absolute top-0 bottom-0 left-2 my-auto h-6 w-6 text-neutral-n0 group-hover:text-neutral-n50 active:text-neutral-n200">
        <GripIcon></GripIcon>
      </button>
      ...
      <button className="absolute top-0 right-2 bottom-0 my-auto h-5 w-5 text-neutral-n0 group-hover:text-neutral-n50 focus:text-neutral-n200 active:text-neutral-n200">
