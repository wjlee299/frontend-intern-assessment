...
const WorkflowStepBox: React.FC<WorkflowStep> = ({ id, index, action }) => {
  ...
  return (
    <div
      className={`group relative w-full cursor-pointer rounded-lg bg-neutral-n0 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.15)] transition-all duration-300 border ${currStep?.id == id && isOpen ? "border-extended-dark-blue-25" : "border-neutral-n30"}`}
    >
